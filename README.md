...
- Logs console ou réseau
- Tests effectués
- Apparition du problème (date / version)
- Impact utilisateur
...
Tous les éléments sont documentés à des fins d’analyse, d’apprentissage et de partage technique.
